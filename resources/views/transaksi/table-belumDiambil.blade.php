        ...
        <table class="table table-striped" id="table1">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><a class="badge bg-success" data-bs-toggle="modal" data-bs-target="{{ '#konfirmasi'.$transaksi->id }}"><i data-feather="check-circle"></i></a></td>
                    <div class="modal fade text-left" id="{{ 'konfirmasi'.$transaksi->id }}" tabindex="-1" role="dialog" aria-labelledby="{{ 'konfirmasiLabel'.$transaksi->id }}" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-scrollable" role="document">
                            <div class="modal-content">
                                ...
                                <form action="/transaksi/belum_ambil/{{ $transaksi->id }}/konfirmasi" method="post">
                                    @csrf
